...
SELECT COUNT(*) AS quantityOfAllCars FROM cars;
...
SELECT COUNT(*) AS quantityOfCars FROM cars WHERE brand='Chevrolet';

-- #7 Display the average year of manufacture of cars
SELECT AVG(year_of_issue) AS averageYearOfManufacture FROM cars;
...
SELECT SUM(price) AS totalAmont FROM cars WHERE brand='Mercedes-Benz';

-- #13 Display the most expensive car & the cheepest car
SELECT MIN(price) AS minimum, MAX(price) AS maximum FROM cars;
